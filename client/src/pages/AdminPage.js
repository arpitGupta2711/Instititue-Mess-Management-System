        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12}>
            <Paper style={{
              ...
              >
                <Typography sx={{ typography: { lg:'h4' ,xs: 'h4' }} } color='text.secondary' >Feedbacks</Typography>  
            ...
            <Table sx={{ minWidth: 650 }} aria-label="simple table">
                ...
                <TableHead>
                 <TableRow>
                    <TableCell sx={{ typography: { lg:'h5' ,xs: 'h6' }} }>S.no</TableCell>
                    <TableCell sx={{ typography: { lg:'h5' ,xs: 'h6' }} }>Feedback</TableCell>
                    <TableCell align="left" sx={{ typography: { lg:'h5' ,xs: 'h6' }} }>Rating</TableCell>
                 </TableRow>
                </TableHead>
                ...
                <TableBody>
                    ...
                    // ))} */}
                        ...
                        <TableCell align="left">Good but can improve</TableCell>
